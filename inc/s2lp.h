...
#define S2LP_RF_OUTPUT_POWER_DBM_MIN    (-49)
...
typedef enum {
    ...
    S2LP_ERROR_TX_FIFO_DATA_SIZE,
    S2LP_ERROR_PREAMBLE_PATTERN,
    S2LP_ERROR_SYNC_WORD_SIZE,
    S2LP_ERROR_CRC_MODE,
    ...
    S2LP_ERROR_HW_FUNCTION_NOT_IMPLEMENTED,
...
/*!******************************************************************
 * \enum S2LP_crc_mode_t
 * \brief S2LP CRC computation modes.
 *******************************************************************/
typedef enum {
    S2LP_CRC_MODE_DISABLED = 0,
    S2LP_CRC_MODE_0X07,
    S2LP_CRC_MODE_0X8005,
    S2LP_CRC_MODE_0X1021,
    S2LP_CRC_MODE_0X864CBF,
    S2LP_CRC_MODE_LAST
} S2LP_crc_mode_t;
...
/*!******************************************************************
 * \fn S2LP_status_t S2LP_set_common_configuration(void)
 * \brief Configure S2LP fixed registers.
 * \param[in]   none
 * \param[out]  none
 * \retval      Function execution status.
 *******************************************************************/
 ...
 * \param[in]   crc_mode: CRC computation mode.
 * \param[out]  none
 * \retval      Function execution status.
 *******************************************************************/
